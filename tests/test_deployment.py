...
class TestEnvironmentVariableOverrides:
    ...
    def test_port_override(self):
        ...
        try:
            ...
            with app.test_client() as client:
                ...
                # Note: This will fail if DB is not available, but that's OK for this test
    ...
    def test_postgres_port_override(self):
        ...
        original_host = os.environ.get("POSTGRES_HOST", "127.0.0.1")
...
class TestEnvironmentHierarchy:
        ...
        try:
            ...
            with app.test_client() as client:
                ...
                if response.status_code == 200:
                    ...
                    assert data["service_name"] == os.environ.get("SERVICE_NAME", "python-uv")
    ...
    def test_command_line_override_precedence(self):
        """Test that command-line environment variables take precedence over .env file."""
